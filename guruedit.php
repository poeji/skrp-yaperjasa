...
<?php
$dg = mysql_fetch_array(mysql_query("select * from data_guru where nip = '".$_GET['id']."'"));
?>
<h3>Edit Guru <?php echo $dg['nama_guru']; ?> [<?php echo $dg['nip']; ?>]</h3>
					</div>
                    <form id="register-form" name="formguru"  action="?mod=gurueditproses" method="post">
						  <fieldset>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="span6 typeahead required datepicker" id="tgl_lahir" name="tgl_lahir" value="<?php echo $dg['tgl_lahir']; ?>" placeholder="Tanggal Lahir" >
                              </div>
                            </div>
