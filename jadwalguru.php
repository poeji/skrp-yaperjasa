...
function cetakjadwal(id) {
    window.open("cetakjadwalguru.php?id="+id, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=700, height=800");
}
</script>
<h3>Data Jadwal</h3>
