...
<a href="?mod=nilaipengetahuandata">Kembali</a>
<br /><br />
						...
						<table class="tabel">
						  ...
						  <?php
						  $thndpn = date("Y") + 1;
						  		$q = mysql_query("SELECT * FROM `nilai_pengetahuan` p LEFT JOIN data_siswa s ON s.`nis` = p.`nis` WHERE tahun_ajaran in ('".date("Y")."', '$thndpn') and p.nis = '".$_GET['id']."' AND nip = '".$_SESSION["userid"]."'");
