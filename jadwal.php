...
<a href="?mod=jadwaltambah">Tambah Data Jadwal</a>
<br /><br />
...
ORDER BY j.`hari`, j.`jam` ASC");
						  ...
						  ?>
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="?mod=jadwaledit&id=<?php echo $d['id_jadwal']; ?>">
										Edit
									</a>
                                    <a class="btn btn-info" href="?mod=jadwalhapus&id=<?php echo $d['id_jadwal']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus jadwal <?php echo $d['nama_pelajaran']." di kelas ".$d['nama_kelas']; ?>?');">
										Hapus
									</a>
								</td>
							</tr>
