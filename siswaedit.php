...
<?php
$ds = mysql_fetch_array(mysql_query("select * from data_siswa where nis = '".$_GET['id']."'"));
$mintahun = (date("Y")-1)."-".date("Y");
$plustahun = (date("Y"))."-".(date("Y")+1);
?>
<h2>Edit Siswa <?php echo $ds['nama_siswa']; ?> [<?php echo $ds['nis']; ?>]</h2>
					</div>
                    <form id="register-form" name="formsiswa"  action="?mod=siswaeditproses" method="post">
						  <fieldset>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="span6 typeahead required datepicker tgl" id="tanggal_lahir" name="tanggal_lahir" placeholder="Tanggal Lahir"value="<?php echo $ds['tanggal_lahir']; ?>" >
                              </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                  ...
                                  <?php
                                        $qagama = mysql_query("select * from data_kelas order by nama_kelas ASC");
